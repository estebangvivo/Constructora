    ...
    <main className="min-h-dvh px-5 py-8 sm:px-10 sm:py-12">
        ...
        <section className="mx-auto flex min-h-[80vh] max-w-xl flex-col justify-center">
          ...
          <form onSubmit={buscarDni} className="mt-10 space-y-5" noValidate>
            <label className="block">
              <span className="mb-2 block text-sm font-bold uppercase tracking-[.2em] text-[#f97316]">
                DNI
              </span>
              ...
              <input
                ...
                className="w-full rounded-2xl border-2 border-neutral-700 bg-[#111111] px-6 py-5 text-center text-3xl font-extrabold tracking-widest text-white outline-none transition focus:border-[#f97316]"
              />
            </label>
            <button
              type="submit"
              disabled={cargandoLogin}
              className="w-full rounded-2xl bg-[#f97316] px-6 py-5 text-2xl font-extrabold text-black transition hover:bg-[#fb923c] disabled:cursor-not-allowed disabled:bg-neutral-700 disabled:text-neutral-400"
            >
      ...
      {paso === "nombre" && (
        <section className="mx-auto flex min-h-[80vh] max-w-xl flex-col justify-center">
          ...
          <p className="mt-4 text-center text-xl text-neutral-400">
            DNI <span className="font-bold text-[#f97316]">{dni}</span> no
          ...
          <form onSubmit={registrarNombre} className="mt-10 space-y-5" noValidate>
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-2xl border-2 border-neutral-700 bg-[#111111] px-6 py-5 text-center text-2xl font-bold text-white outline-none transition focus:border-[#f97316]"
              />
            </label>
            <button
              type="submit"
            ...
            <button
              ...
              className="w-full rounded-xl px-4 py-3 font-bold text-neutral-400 hover:text-[#f97316]"
            >
              Volver
            </button>
          </form>
      ...
      {paso === "categorias" && cliente && (
        <>
          <header className="mx-auto mb-10 max-w-6xl text-center">
            <Logo />
            <p className="text-sm font-bold uppercase tracking-[.25em] text-[#f97316]">
              Hola, {cliente.nombre}
            </p>
            ...
            <button
              ...
              className="mt-4 text-sm font-bold text-neutral-500 underline-offset-4 hover:text-[#f97316] hover:underline"
            >
          ...
          <section className="mx-auto grid max-w-6xl items-stretch gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {opciones.map((opcion) => (
              <button
                ...
                className="group flex h-full min-h-[17rem] flex-col items-center rounded-[2rem] border-2 border-neutral-800 bg-[#111111] px-5 py-7 text-center shadow-lg transition duration-200 hover:-translate-y-1 hover:border-[#f97316] hover:shadow-[0_0_40px_rgba(249,115,22,0.25)] active:translate-y-0 disabled:cursor-wait disabled:opacity-60 sm:px-6 sm:py-8"
              >
                <span className="grid h-20 w-20 shrink-0 place-items-center rounded-full bg-[#f97316] text-4xl font-extrabold text-black transition group-hover:bg-[#fb923c]">
                  {opcion.icono}
                </span>
                ...
                <span className="mt-3 flex min-h-[3rem] w-full items-start justify-center text-center text-base leading-snug text-neutral-400 sm:min-h-[3.25rem] sm:text-lg">
                  {opcion.descripcion}
                </span>
              </button>
            ))}
      ...
      {(cargando || turno) && (
        ...
        >
          <div className="w-full max-w-lg rounded-3xl border border-neutral-800 bg-[#111111] p-10 text-center shadow-2xl">
            {turno ? (
              <>
                <p className="text-sm font-extrabold uppercase tracking-[.25em] text-[#f97316]">
                  Turno registrado
                </p>
                <p className="mt-4 text-xl font-bold text-neutral-400">
              ...
              <>
                <div className="mx-auto mb-6 h-14 w-14 animate-spin rounded-full border-4 border-neutral-700 border-t-[#f97316]" />
